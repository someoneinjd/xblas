...
// API of the reconfigurable matrix multiplication.The interface will be invoked by the SYRK implementation below.
                    ...
                    for (int iii = 0; iii < III; iii++) {
                        for (int jjj = 0; jjj < JJJ; jjj++) {
                            ...
                            if (total_i < m && total_j < n) {
                                if (j < i)
                                    c[total_j + total_i * ldc] = Output_buffer(iii, ii, jj, jjj, i, j);
                                else
